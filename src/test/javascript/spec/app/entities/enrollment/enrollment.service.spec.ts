    ...
    describe('Enrollment Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/enrollments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Enrollment', () => {
                service.create(new Enrollment(null)).subscribe(received => {
            ...
            it('should update a Enrollment', () => {
                service.update(new Enrollment(123)).subscribe(received => {
